...
![Typing SVG](https://readme-typing-svg.herokuapp.com?font=Ubuntu+Mono&size=18&duration=2000&pause=1000&color=00F5A0&vCenter=true&multiline=true&width=450&height=80&lines=🔥+ML+Enthusiast;📊+Data+Scientist;⚗️+Research+Innovator)

<!-- Second Animation Set: Featured Projects (with delay) -->
![Typing SVG](https://readme-typing-svg.herokuapp.com?font=Ubuntu+Mono&size=18&duration=2000&pause=1000&color=58A6FF&vCenter=true&multiline=true&width=450&height=80&lines=⚡+CSM-SR;🎯+IntellijSense;🛠️+Code+Crafters&repeat=true&delayStart=6000)
